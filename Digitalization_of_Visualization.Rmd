...
author: <br><br><br><br><br>Marcus Adams
date: April 10, 2019
params:
  genFigs: FALSE
output: 
...
<aside class="notes">
  * Pre-dates germ theory
  * Plot saw cases were clustered around a water pump
  * Thus epidemiology was born with a visualization
  * Think about the effort to develop the plot
  * Have we lost it with our ability to quickly plot?
<aside>
...
```{r}
  if(params$genFigs) source("R/VizTasks.R")
```


<aside class="notes">
  * Data only speaks for itself with the voice you give it.
  * The design choices you make will have an impact
</aside>
...
<aside class="notes">
  ...
  * Astute viewer realizes I broke with Merck template
</aside>

## Not Every Plot Deserves Its Own Theme

<img src="img/BaseCtrlChart.png" class = "noframe" style="width: 55%; margin: -60px 0 0 0;">

<img src="img/jmpCtrlChart.png" class = "noframe" style="width: 55%; margin: -65px 0 0 0;">
...
<aside class="notes">
  * Excel can do many things
    + And we do use it for many things...
  ...
  * Many things you are aware of, but way of thinking
...
<img src="img/digitalProd.png" class="noframe" style="margin-top: 7%;"> 
...
<img src="img/vizTriad.png" class="noframe" style="width: 65%;">

<aside class="notes">
  Concept from Thomas Lin Pedersen userR 2018
  
  * Static Viz - the bread and butter
  * Interactive Viz
  * Motion Viz
</aside>

## Static Digital Visualizations {data-background-color="#586638"}
<!-- RGB 88 102 56 -->

<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Bitmap_VS_SVG.svg/768px-Bitmap_VS_SVG.svg.png">

<aside class="notes">
  * Raster is similar to analog printing
  * SVG allows scaling (first principles of visualizations)
  * Transferable (send link)
  * Include by Reference (need to discussion around data integrity)
    + Image above
  * Combinations
</aside>

## Interactive Visualizations {data-background-color="#2288a8"}
<!-- RGB 34 136 168 -->

<img src="img/interactViz.gif" class="noframe" style="width: 80%;">

<aside class="notes">
  * Compact form (one visualization can encompass 40 with a selector)
  * Let people ask their own questions
  * Drill down without drinking from the fire hose
</aside> 

## Motion Visualizations {data-background-color="#ecbd8b"}
<!-- RGB 236 189 139 -->

<img src="img/animateViz.gif" class="noframe" style="width: 60%;">

<aside class="notes">
 * Use for illustrating a time dimension
 * Under appreciated
 * Saw some pretty awesome CFD/FEM
 * Want to lower the bar to entry
 * No longer screen shots, but fluid transitions
 * Instructions - SOP with steps for analysis
</aside>

<!-- ## Multi-Modal -->

<!-- <img src="img/multiViz.gif" class="noframe" style="width: 75%;"> -->

<!-- <aside class="notes"> -->
<!--   * Not stuck at static but free to roam the triangle -->
<!--   * Show you interactions -->
...
Sets the stage (not inherent) for
  ...
  * Reproducible research and reports 
    ...
    + Dashboard instead of manual list
    + Traceability
  * Extensibile 
...
<blockquote class="single-quote" style="text-shadow: 2px 2px 2px #000000; background: rgba(255, 255, 255, 0.2); margin-bottom: 1em;">
...
<br>
<img align="left" class="noframe logo" src=`r if(file.exists("img/mrk_logo.png")) knitr::image_uri("img/mrk_logo.png")`></img>
...
<aside class="notes">
  ...
  * Small piece, but data is our product 
  * Better visualizations = better faster insights
  * Better faster insights = better products that get to patients faster
